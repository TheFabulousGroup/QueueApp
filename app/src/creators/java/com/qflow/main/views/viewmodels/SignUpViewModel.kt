    ...
    private val createUser: CreateUser
        ...
        fun saveUserInDatabase(
            ...
            createUser.execute({ it.either(::handleFailure, ::handleUserCreated) },
                CreateUser.Params(selectedUsername, selectedEmail, selectedPass, selectedRepeatPass, selectedNameLastName,selectedCIF,selectedLocation), this.coroutineScope
            )
        }
