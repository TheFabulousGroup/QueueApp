//Based on Copyright 2018, The Android Open Source Project

package com.qflow.main.domain.local.database
...
import com.qflow.main.domain.local.database.user.UserDatabaseDao
